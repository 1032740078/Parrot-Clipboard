  ...
  return (
    ...
    >
      ...
      <div className="mx-3 mt-2 flex h-24 items-center gap-3 rounded-lg bg-white/5 px-4 text-white">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-2xl">{icon}</div>
        <div className="min-w-0 flex-1">
          <div className="truncate text-sm font-medium leading-5">{meta?.primary_name ?? previewText}</div>
