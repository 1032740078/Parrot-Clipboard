...
export const VideoPreview = ({ detail }: VideoPreviewProps) => {
  ...
  return (
    <section className="flex h-full w-full items-center justify-center overflow-y-auto px-5 py-5">
      <div className="w-full max-w-[980px] space-y-4">
        ...
        <div className="rounded-[26px] border border-white/10 bg-[#020617] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
        {canPlay ? (
          <video
            autoPlay
            className="aspect-video max-h-[58vh] w-full rounded-[22px] bg-black/90 object-contain"
            controls
        ...
        <div className="rounded-[22px] border border-white/8 bg-black/20 px-4 py-3 text-xs text-slate-400">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 break-all text-slate-200" data-testid="preview-video-path">
                {sourcePathLabel}
              </div>
            </div>
